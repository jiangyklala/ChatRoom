package libClink.impl;

import libClink.core.IoArgs;
import libClink.core.IoProvider;
import libClink.core.Receiver;
import libClink.core.Sender;
...
public class SocketChannelAdapter implements Sender, Receiver {
    ...
    public boolean sendAsync(IoArgs args, IoArgs.IoArgsEventListener listener) throws IOException {
        ...
        outputCallback.setAttach(args);   // 当前发送的数据附加到回调中
